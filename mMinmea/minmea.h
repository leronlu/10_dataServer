...
// provide backwards compatibility to users expecting a null-terminated std::string
// instead of a struct
union minmea_type {
  char buf[6];
  struct {
...
/**
 * Check whether a character belongs to the std::set of characters allowed in a
 * sentence data field.
 */
